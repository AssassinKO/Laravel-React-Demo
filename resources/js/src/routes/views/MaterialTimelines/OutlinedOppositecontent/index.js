...
const breadcrumbs = [
  ...
  { label: 'Outlined & Opposite content', isActive: true },
];

const OutlinedOppositecontent = () => {
  const { timeline } = coremat;

  return (
    <PageContainer heading="Outlined & Opposite content" breadcrumbs={breadcrumbs}>
...
export default OutlinedOppositecontent;
