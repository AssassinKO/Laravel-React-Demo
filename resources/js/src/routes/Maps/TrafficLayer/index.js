...
import TrafficLayerExample from './demo/TrafficLayerExample';
...
const demos = [
  {
    label: 'Traffic Layer',
    link: 'traffic-layer',
    component: <TrafficLayerExample />,
    filename: './TrafficLayerExample.txt',
  },
];
...
const breadcrumbs = [
  ...
  { label: 'Traffic Layer', isActive: true },
];

export default function TrafficLayer() {
  const classes = useStyles();
  return (
    <ComponentsDemo pageTitle="Traffic Layer" menus={demos} breadcrumbs={breadcrumbs}>
